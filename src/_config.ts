...
export const fs_title: string =
  '感谢使用由 <em class="keyword">GamerNoTitle</em> 提供的哔哩漫游服务器';
//封面
...
//立即观看按钮-主选项标题
export const fs_watch_button_title: string = "项目主页";
//立即观看按钮-主选项链接
export const fs_watch_button_link: string = "https://bili33.top/biliroaming/";
//追番按钮-追番
